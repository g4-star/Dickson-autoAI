...
class GmailProvider(EmailProvider):
    """Gmail API provider with paginated mailbox reading."""
    ...
    def fetch_message_page(
        ...
        *,
        ...
        """
        Fetch one Gmail page and return the next page token.

        This is the preferred method for progressive mailbox syncing.
        """
        if page_size < 1:
            return [], None
        ...
        return messages, response.get("nextPageToken")
